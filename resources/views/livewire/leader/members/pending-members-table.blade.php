  ...
  <div class="container-fluid w-full flex flex-wrap items-center justify-between px-6">
    <nav class="bg-grey-light rounded-md w-full" aria-label="breadcrumb">
      <ol class="list-reset flex">
        ...
        <li><span class="text-gray-500 mx-2 text-sm">/ Pending Members</span></li>
      </ol>
    </nav>
  </div>
</nav>  
                            ...
                            <tbody>
                                ...
                                <td class="p-2">{{  $employee->user->email}}</td>                                 
                                    <td class="flex justify-center">
                                        <form  method="POST" action="{{ route('leader.dashboard.show.pendingAccept', $employee->id) }}" onsubmit="return confirm('are you sure')">
                                          @csrf
                                        <button type="submit" class="bg-green-500 p-2 text-white hover:shadow-lg text-xs font-thin">Accept</button>
                                        </form>
                                    </td>
                                </tr>
                                ...
                                @empty
                                               <tr class="bg-white text-center border-b text-xs text-gray-600 py-5">
                                <td class="p-2">No pending members
                                    </td>  
