  ...
  <div class="container-fluid w-full flex flex-wrap items-center justify-between px-6">
    <nav class="bg-grey-light rounded-md w-full" aria-label="breadcrumb">
      <ol class="list-reset flex">
        <li><a href="{{ route('admin.organizations') }}" class="text-gray-500 hover:text-gray-600 text-sm">Organization</a></li>
 ...
 <div class="flex w-full mt-3">
                ...
                <div class="flex  justify-end w-full">
                    <div class="w-full"> <div class="flex justify-end space-x-4">
                     <button type="button" data-bs-toggle="modal" data-bs-target="#organizationModal" class="w-10 flex items-center justify-center h-10 rounded-full  bg-green-700 hover:bg-green-500 rounded-md text-white "><i class="fas text-lg fa-plus"></i></button>
                        ...
                        <thead class="border-b-4 border-dark-700 ">
                            ...
                            @forelse ($organizations as $organization )
                              <tr class="bg-gray-100 text-center border-b  text-gray-600">
                                 <td class="p-2 bg-white  text-xs">{{ $organization->name }}</td>

                                                <td class="p-2  bg-white text-xs flex space-x-2 justify-center">
                                            <button type="button" data-bs-toggle="modal" data-bs-target="#updateOrganizationModal" wire:click="editOrganization({{ $organization->id }})"><i class="fa-regular fa-pen-to-square bg-blue-500 p-1 text-slate-100 rounded-md "> </i>   </button>
                                                   
                              <form  method="POST" action="{{ route('admin.organizations.delete', $organization->id) }}" onsubmit="return confirm('are you sure')">
                                        @csrf
                                        @method('DELETE')
                            ...
                            <td class="text-lg">Empty Table</td>
...
@include('admin.organizations.create-organizations-modal')
