                        ...
                        <tbody>
                            ...
                            @forelse ( $appointments as $appointment )
                              ...
                              <tr class="bg-gray-100 text-center border-b  text-gray-600">
                               ...
                               <td class="p-2  bg-white text-xs flex space-x-2 justify-center"> <a href="{{ route('admin.shedule-view.edit', $appointment->id) }}"><i class="fa-regular fa-pen-to-square bg-blue-500 p-1 text-slate-100 rounded-md "></a></i>  
