  ...
  <div class="container-fluid w-full flex flex-wrap items-center justify-between px-6">
    <nav class="bg-grey-light rounded-md w-full" aria-label="breadcrumb">
      <ol class="list-reset flex">
        ...
        <li><span class="text-gray-500 mx-2 text-sm">/ Edit Activity</span></li>
      </ol>
    </nav>
  </div>
</nav>  
    ...
    <form action="{{ route('admin.activities.update', $activity->id) }}" method="POST" class="space-y-4">
    @csrf
          <div>
          ...
          <div>
           ...
           <div class="mb-6">
                            <label class="block">
                                ...
                                <input type="checkbox" name="status" wire:model="attendance" />
                            </label>
                            @error('status')
