...
<input type="text" name="title" placeholder="Title" class="bg-gray-0 block border-b-2 w-1/2 h-10 text-3xl outline-none">

<textarea name="description" id="" placeholder="description" class="py-10 bg-gray-0 block border-b-2 w-1/2 h-30 text-xl outline-none"></textarea>
