...
<div class="modal fade text-left" id="organizationModal" tabindex="-1" role="dialog" aria-hidden="true">
...
<div class="modal-dialog modal-lg" role="document">
    ...
    <div class="modal-body">
          ...
          <form action="{{ route('admin.organizations.store') }}" method="post" enctype="multipart/form">
@csrf
...
{{-- Update --}}
   ...
   <div wire:ignore.self class="modal fade text-left" id="updateOrganizationModal" aria-labelledby="updateStudentModalLabel" tabindex="-1" role="dialog" aria-hidden="true">
