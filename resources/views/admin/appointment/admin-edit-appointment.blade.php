<x-admin-layout>
    ...
    <nav class="bg-grey-light rounded-md w-full" aria-label="breadcrumb">
      <ol class="list-reset flex">
        ...
        <li><span class="text-gray-500 mx-2 text-sm">/</span></li>
         <li><span class="text-gray-500 hover:text-gray-600 text-sm">Edit Appointment</span></li>
        <li><span class="text-gray-500 mx-2 text-sm">/</span></li>
      </ol>
    </nav>
  </div>
 ...
 <div class="my-6">
    <p class="text-lg">Edit Appointment</p>
        ...
        <div class="appointment-details ml-3">
            ...
            <div class="appointment-specific-details  mt-4">
              ...
              <p class="text-lg "> <span class="font-bold"> Date Time: </span> {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $appointment->start_time)->format('M d Y g:i A')}}</p>
                ...
                <p class="text-lg "> <span class="font-bold"> Message: </span> {{   $appointment->message, 100?: 'No message'}} </p>
            </div>
              ...
              <label class="inline-block text-center border w-full py-1 px-1 bg-rose-600 text-white peer-checked:bg-rose-800 drop-shadow-[0_1px_1px_rgba(0,0,0,0.25)] peer-checked:text-white peer-checked:border"
                  for="reject"> Reject </label> </div>
                   ...
                   <div class="w-full my-2">
                    <a href="{{ route('admin.appointmentfollow.followup',  ['id' => $appointment->id])}}" class=" text-center border w-full py-1 px-1 bg-sky-600 text-white peer-checked:bg-sky-800 drop-shadow-[0_1px_1px_rgba(0,0,0,0.25)] peer-checked:text-white peer-checked:border">Follow Up</a>
                    </div>
                    </div>

                        <div class="mt-4 w-full">
                   <div class="w-full my-2">
                    <a href="{{ route('admin.schedule.index',  ['id' => $appointment->id])}}" class=" text-center border w-full py-1 px-1 bg-sky-600 text-white peer-checked:bg-sky-800 drop-shadow-[0_1px_1px_rgba(0,0,0,0.25)] peer-checked:text-white peer-checked:border">Schedule</a>
                    </div>
                    </div>
          ...
          <div class="mt-1">
            ...
            <div class="flex gap-2  ">
                  ...
                  <div class="mt-4 w-full">
            <input type="radio" id="accept"  name="status"  value="accepted" class="hidden peer">
            <label class="justify-self-auto text-center border w-full py-1 px-1 bg-sky-600 text-white peer-checked:bg-sky-800 drop-shadow-[0_1px_1px_rgba(0,0,0,0.25)] peer-checked:text-white peer-checked:border"
                for="accept"> Accept</label> </div> 
                  <div class="mt-4 w-full">
                        <input type="radio" id="reject"  name="status"  value="rejected" class="hidden peer">
              <label class="inline-block text-center border w-full py-1 px-1 bg-rose-600 text-white peer-checked:bg-rose-800 drop-shadow-[0_1px_1px_rgba(0,0,0,0.25)] peer-checked:text-white peer-checked:border"
                  for="reject"> Reject </label> </div>
            ...
            <div class="w-full my-2">
              @if(!empty($appointment->schedule->id))
                  <a href="{{ route('admin.shedule-view.edit', $appointment->schedule->id) }}" class="justify-self-auto text-center border w-full py-1 px-1 bg-sky-600 text-white peer-checked:bg-sky-800 drop-shadow-[0_1px_1px_rgba(0,0,0,0.25)] peer-checked:text-white peer-checked:border"> View Schedule</a>
                  @endif
